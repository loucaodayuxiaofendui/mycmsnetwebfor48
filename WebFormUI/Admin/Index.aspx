<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="WebFormUI.Admin.Index" %>
    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a href="javascript:void(0)"><asp:Label ID="admin" runat="server" >管理员ID</asp:Label></a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">交流博客：</label><span class="res-info"><a href="javascript:void(0)" title="个人博客首页" target="_blank">博客</a></span>
                    </li>
                    <li>
                        <label class="res-lab">交流邮箱：</label><span class="res-info">fangyong809178958@163.com</span>
                    </li>
                    <li>
                    </li>
                </ul>
